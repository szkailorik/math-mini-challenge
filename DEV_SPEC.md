...
- `buildSetReviewFollowupHTML`: keeps the set report preview-first by rendering the audit, counts, and preview actions without expanding all variant rows or answer references in the report body.
