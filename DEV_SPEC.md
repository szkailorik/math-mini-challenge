...
- `buildSetReviewFollowupItems` caches generated variant packs by student, set, program, and mistake signature so preview, print, answer sheets, and grading stay aligned; `regenerateSetReviewFollowupPreview` clears that cache for a deliberate new pack.
