...
- Answer-print CSS now forces a page break before answer section five and compacts answer rows/tips in print mode; runtime validation specifically replays Set 86 Lorik section five, checks all 12 `分数四则运算` answer rows, stages them through answer printing, and saves them into a report session to prevent answer-key/report drift.
