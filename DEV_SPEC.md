...
- `showCalculationQuickReview`: renders the child-facing `16大终极心智模型 / 名师词典` page using a stable 16-model registry, core/advanced model labels, per-model `什么时候用` cues, stage-aware emphasis copy, recommendation chips, jump-to-topic helpers, and dedicated print markup.
