...
- `getSessionAnswerKeyAudit`: compares each saved report mistake back to the cached original answer key by row key, surfacing an `答案对齐 n/n` count in the set report and flagging answer drift before parents use the report for paper correction.
